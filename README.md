...
**CSF** computes continuous sectional properties - $A(z)$, $I(z)$, $EI(z)$, $GJ(z)$ - for tapered and non-homogeneous members, exported as **CSV** and **YAML** for direct integration with any beam solver (OpenSees, SAP2000, and others) or section analysis tools** (e.g. Sectionproperties).
