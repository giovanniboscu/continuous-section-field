**[Key Features](#key-features)** • **[Installation & Quick Start](## Installation & Quick Start)** • **[Practical Example](#8-practical-example-continuously-tapered-t-beam)** • **[Model Validation (Cylinder)](#5-model-validation-circular-hollow-section)** • **[NREL 5-MW Validation](#6-advanced-validation-nrel-5-mw-reference-wind-turbine-tower)**
