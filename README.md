**[Key Features](#key-features)** • **[Installation & setup](#setup-environment-linux--windows)** • **[Continuously Tapered Beam Example](#practical-example-continuously-tapered-t-beam)** • **[Validation](#  Numerical Validation: Circular Hollow Section)** • **[NREL 5-MW Case Study ](#6-advanced-validation-nrel-5-mw-reference-wind-turbine-tower)**
