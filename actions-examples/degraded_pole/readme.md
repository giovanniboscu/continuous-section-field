...
The physical case is a prestressed concrete pole represented by 80 polygons, with localized degradation affecting selected components. Its geometry, material distribution, and component-specific participation laws are defined through a flexible and customizable parametric model.
...
The file represents the physical pole through:
...
4. the longitudinal laws governing axial/bending and shear/torsion stiffness.

> The model can be regenerated with different pole dimensions, radial layers, angular sectors, prestressing bars, reference material properties, and degradation laws. The available parameters and the complete generation procedure are described in [`create_tapered_pole_explained.md`](https://github.com/giovanniboscu/continuous-section-field/blob/main/actions-examples/degraded_pole/create_tapered_pole_explained.md).

The guide explains how the healthy reference model is generated and how the selected longitudinal degradation laws are applied to produce the final YAML model.
    ...
    S0:
      ...
      polygons:
        0_1_C:
          ...
          vertices:
          - [8.113285044351216e-18, 0.1325]
          - [-0.003251712779285859, 0.13246009347724708]
          - [-0.0065014668483828865, 0.13234039794718536]
          - [-0.009747304676955922, 0.13214098550992645]
          - [-0.012987271093666786, 0.1318619762840661]
            # ...
    ...
    S1:
      ...
      polygons:
        0_1_C:
          weight: 35000000000.0
          vertices:
          - [3.980102097228898e-18, 0.065]
          - [-0.0015951798539892894, 0.06498042321525328]
          - [-0.0031893988312821707, 0.06492170465333622]
          - [-0.004781696633978377, 0.06482387968411486]
          - [-0.006371114121421442, 0.0646870072336928]
          - [-0.00795669388794905, 0.06451116974891614]
          - [-0.009537480839598506, 0.06429647314771077]
          - [-0.011112522769419582, 0.06404304675528118]
            # ...
...
### 2.4 Default variation of polygon weights between `S0` and `S1`
