...
---
>
>The YAML geometry is generated by `csf.utils.writegeometry_rio_v2`, a parametric script for automatic geometry construction, launched by `create_yaml-histwin.sh`.
>
>For more details, see the [writegeometry_rio_v2 guide](https://github.com/giovanniboscu/continuous-section-field/blob/main/docs/writegeometry_rio_v2_guide.md).
>
---
