...
# =============================================================================
# The pier head (cap beam) widens to:
...
# Outer row : 44 bars Ø25 mm   area = pi/4 * 0.025^2 = 4.91e-4 m²
# Inner row : 32 bars Ø20 mm   area = pi/4 * 0.020^2 = 3.14e-4 m²
...
out="${SCRIPT_DIR}/../yaml/pier_seg3.yaml"
