...
s0_x=0.0;  s0_y=0.0
s0_dx=6.40; s0_dy=3.60; s0_R=0.30; s0_tg=0.70; s0_t_cell=0.0

# --- Head section S1  (z = 8 m — top of plastic-hinge zone) ---
# Must match S0 of Segment 2 exactly.
s1_x=0.0;  s1_y=0.0
s1_dx=5.20; s1_dy=3.20; s1_R=0.30; s1_tg=0.60; s1_t_cell=0.0
...
n_bars_row1=48;      n_bars_row2=32
area_bar_row1=0.000616;  area_bar_row2=0.000380
dist_row1_outer=0.089;   dist_row2_inner=0.086
rebar_weight=1.0

# --- Output ---
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
out="${SCRIPT_DIR}/../yaml/pier_seg1.yaml"
