...
You describe your cross-section once in a YAML file and get the full sectionproperties result set — area, moments of inertia, warping constant, shear areas and more — at any position along the member axis. Use it as a standalone tool with no Python code required, or import it directly as a Python library in your own pipeline.
