...
> **Note.** For sections with isotropic behaviour at each station, torsional quantities can be evaluated through the `csf_sp` bridge to `sectionproperties`. See: [`csf_sp` User Guide](https://github.com/giovanniboscu/continuous-section-field/blob/main/docs/csf_sp_user_guide.md).
