...
- Output file: `docs/API/section_field_api_en.md`
- Top-level function definitions found: `71`.
...
- `def get_lobatto_intervalsz_min: float, z_max: float, n_intervals: int` - line 105
- `def compute_lobatto_integration_pointsz_min: float, z_max: float, n_points: int=5, L: float=None` - line 123
- `def _compute_station_datafield: Any, z_values: Sequence[float]` - line 190
- `def _parse_optional_floatvalue: Any` - line 268
- `def write_sap2000_template_packfield: Any, n_intervals: int=20, template_filename: str='export_template_pack.txt', *, mode: Literal['BOTH', 'CENTROIDAL_LINE', 'REFERENCE_LINE']='BOTH', section_prefix: str='SEC', material_name: str='S355', E_ref=None, nu=None, include_plot: bool=True, plot_filename: str='section_variation.png', show_plot: bool=True, z_values: Optional[List[float]]=None, plot_n: int=100, float_fmt: str='.9g'` - line 272
- `def write_sap2000_geometry*args: Any, **kwargs: Any` - line 631
- `def _csf__is_finite_numberx: Any` - line 646
- `def _csf__ensure_parent_dir_existspath: str` - line 655
- `def _csf__atomic_write_textpath: str, text: str` - line 670
- `def _csf__section_to_Sz_dictsection_obj, nodesection: str` - line 682
- `def _yaml_scalarv` - line 746
- `def _simple_yaml_dumpdata, indent: int=0` - line 770
- `def safe_evaluate_weight_zrelativeformula: str, p0: Polygon, p1: Polygon, z0: float, z1: float, z: float, print=True` - line 796
- `def print_evaluation_reportvalue: float, report: dict` - line 919
- `def evaluate_shear_weight_formulaformula: str, p0: Polygon, p1: Polygon, z0: float, z1: float, zt: float, w: float` - line 969
- `def evaluate_weight_formulaformula: str, p0: Polygon, p1: Polygon, z0: float, z1: float, zt: float` - line 1111
- `def evaluate_weight_formula_zrelativeformula: str, p0: Polygon, p1: Polygon, z0: float, z1: float, z: float` - line 1233
- `def section_geometrysection: Section, fmt='.8f'` - line 1294
- `def section_print_analysisfull_analysis, fmt='.8f'` - line 1315
- `def section_full_analysis_keys` - line 1371
- `def write_opensees_geometryfield, n_points: int, E_ref=None, nu=None, filename: str='geometry.tcl'` - line 1398
- `def _lookup_file_keyfilename: str` - line 1640
- `def _read_lookup_dataresolved_filename: str, file_mtime_ns: int, file_size: int` - line 1659
- `def _build_pchip_interpolatorresolved_filename: str, file_mtime_ns: int, file_size: int` - line 1701
- `def _evaluate_linear_lookupdata: tuple[tuple[float, float], ...], coordinate: float` - line 1750
- `def lookup_tabulated_valuefilename: str, coordinate: float, interpolation: str='linear'` - line 1768
- `def _resolve_eps_aobj: Any` - line 1865
- `def _resolve_eps_kobj: Any` - line 1869
- `def _poly_signed_area_centroidpts: Any, eps_a: float` - line 1877
- `def _principal_inertiasix: float, iy: float, ixy: float` - line 1920
- `def _roark_torsion_recta: float, b: float` - line 1934
- `def _equiv_rectangle_dimsA: float, i_min: float, eps_k: float` - line 1960
- `def compute_saint_venant_Jv2poly_input: Any` - line 1985
- `def calculate_t_eqpoints` - line 2339
- `def compute_saint_venant_J_cellsection: 'Section'` - line 2472
- `def compute_saint_venant_J_wallsection: 'Section'` - line 2988
- `def _poly_vertices_xypoly: Any` - line 3197
- `def _bbox_xyverts: Sequence[PointXY]` - line 3208
- `def _auto_grid_h_from_bboxverts: Sequence[PointXY], auto_n: int` - line 3217
- `def _point_on_segment_sqpx: float, py: float, ax: float, ay: float, bx: float, by: float, eps_l: float` - line 3234
- `def _point_in_poly_inclusivepx: float, py: float, verts: Sequence[PointXY], eps_l: float` - line 3274
- `def _build_inside_maskverts: Sequence[PointXY], xs: np.ndarray, ys: np.ndarray, eps_l: float` - line 3306
- `def _solve_poisson_sormask: np.ndarray, h: float, *, max_iter: int, tol: float, omega: float` - line 3327
- `def _sqx: float` - line 3379
- `def _is_near_zerox: float, eps: float` - line 3383
- `def _signed_area_centroid_xyverts: Sequence[tuple[float, float]]` - line 3393
- `def _poly_signed_area_centroid_xyverts: Sequence[PointXY]` - line 3427
- `def export_to_opensees_tclfield, K_12x12, filename='csf_model.tcl'` - line 3431
- `def assemble_element_stiffness_matrixfield: ContinuousSectionField, E_ref: float=1.0, nu: float=0.3, n_gauss: int=5` - line 3467
- `def polygon_inertia_about_originpoly: Polygon` - line 3567
- `def volume_polygon_list_report_datafield: 'ContinuousSectionField', z1: float, z2: float, n_points: int=20, *, do_debug_check: bool=False, debug_tol: float=1e-09` - line 3607
- `def volume_polygon_list_reportfield: ContinuousSectionField, z1: float, z2: float, *, n_points: int=20, outputs: list[Any] | None=None, fmt_display: str='0.6f', w_tol: float=0.0, do_debug_check: bool=False, debug_tol: float=1e-09` - line 3728
- `def emit_volume_polygon_list_reportreport: Dict[str, Any], *, outputs: List[Any] | None=None, fmt_display: str='0.6f', w_tol: float=0.0` - line 3778
- `def integrate_volumefield: 'ContinuousSectionField', z0: float, z1: float, n_points: int=20, *, idx: int | None=None` - line 3963
- `def section_full_analysissection: Section, compute_vroark=True` - line 4073
- `def polygon_statical_momentpoly: Polygon, y_axis: float` - line 4165
- `def section_statical_moment_partialsection: Section, y_cut: float, reference_axis: float | None=None` - line 4180
- `def section_derived_propertiesprops: Dict[str, float]` - line 4266
- `def section_stiffness_matrixsection: Section, E_ref: float=1.0` - line 4338
- `def _segments_intersectp1, p2, p3, p4` - line 4403
- `def polygon_has_self_intersectionspoly: Polygon` - line 4454
- `def get_points_distancepolygon: Polygon, i: int, j: int` - line 4556
- `def get_edge_lengthpolygon: Polygon, edge_idx: int` - line 4585
- `def list_polygons_with_contentscsf: ContinuousSectionField, z: float` - line 4604
- `def polygon_surface_w1_inners0self: Any, z: float` - line 4735
- `def polygon_surface_w1_inners0_singleself: ContinuousSectionField, z: float, idx: int` - line 4942
- `def export_polygon_vertices_csv_filesection: Section=None, field: ContinuousSectionField=None, zpos: float=None, exp_filename: str='csv_export.txt', z_values: Optional[List[float]]=None, fmt: str='{:.16g}'` - line 5156
- `def export_polygon_vertices_csvsection: Section=None, field: ContinuousSectionField=None, zpos: float=None, put=print, fmt='{:.16g}'` - line 5214
- `def section_propertiessection: Section` - line 5415
- `def _polygon_signed_area_and_centroidpoly: Polygon` - line 5522
- `def polygon_area_centroidpoly: Polygon` - line 5532
...
`tuple`, `Polygon`, `float`, `lookup_tabulated_value`, `get_points_distance`, `eval`, `v0.lerp`, `zip`

### `write_opensees_geometry`

**Source lines:** `1398-1638`
...
### `_build_pchip_interpolator`

**Source lines:** `1701-1748`
...
```python
def _build_pchip_interpolatorresolved_filename: str, file_mtime_ns: int, file_size: int
```

**Summary:** Build and cache a PCHIP interpolator using all lookup points.

**Parameters**

| Name | Kind | Type | Default |
|---|---|---|---|
| `resolved_filename` | `positional or keyword` | `str` | `-` |
| `file_mtime_ns` | `positional or keyword` | `int` | `-` |
| `file_size` | `positional or keyword` | `int` | `-` |

**Returns:** `PchipInterpolator`
...
`lru_cache`, `_read_lookup_data`, `enumerate`, `range`, `PchipInterpolator`, `len`, `ValueError`, `math.isfinite`

### `_evaluate_linear_lookup`

**Source lines:** `1750-1765`

```python
def _evaluate_linear_lookupdata: tuple[tuple[float, float], ...], coordinate: float
```

**Summary:** Evaluate a tabulated law using piecewise-linear interpolation.

**Parameters**

| Name | Kind | Type | Default |
|---|---|---|---|
| `data` | `positional or keyword` | `tuple[tuple[float, float], ...]` | `-` |
| `coordinate` | `positional or keyword` | `float` | `-` |
...
### `lookup_tabulated_value`

**Source lines:** `1768-1832`

```python
def lookup_tabulated_valuefilename: str, coordinate: float, interpolation: str='linear'
```

**Summary:** Evaluate a custom tabulated law.
...
| `coordinate` | `positional or keyword` | `float` | `-` |
| `interpolation` | `positional or keyword` | `str` | `'linear'` |
...
`lower`, `float`, `_lookup_file_key`, `_read_lookup_data`, `_build_pchip_interpolator`, `isinstance`, `TypeError`, `ValueError`, `math.isfinite`, `_evaluate_linear_lookup`, `interpolator`, `interpolation.strip`, `abs`

### `_principal_inertias`

**Source lines:** `1920-1927`
...
`formula.strip`, `re.finditer`, `evaluate_weight_formula_zrelative`, `print_evaluation_report`, `float`, `match.group`, `report.update`, `startswith`, `os.path.exists`, `str`, `os.getcwd`

## Call the tabular printer before returning values

### `print_evaluation_report`

**Source lines:** `919-965`
...
`formula.strip`, `re.fullmatch`, `tuple`, `Polygon`, `float`, `isinstance`, `ValueError`, `re.search`, `lookup_tabulated_value`, `get_points_distance`, `eval`, `v0.lerp`, `abs`, `zip`

## We disable __builtins__ for safety to ensure only provided tools are used.

### `evaluate_weight_formula_zrelative`

**Source lines:** `1233-1292`
...
**Source lines:** `1640-1655`

```python
def _lookup_file_keyfilename: str
```

**Summary:** Return the absolute file path and metadata used as the cache key.
...
`resolve`, `path.stat`, `path.is_file`, `FileNotFoundError`, `str`, `expanduser`, `Path`

### `_read_lookup_data`

**Source lines:** `1659-1697`
...
```python
def _read_lookup_dataresolved_filename: str, file_mtime_ns: int, file_size: int
```

**Summary:** Read and cache all valid coordinate-value pairs from a lookup file.
...
`lru_cache`, `data.sort`, `tuple`, `open`, `ValueError`, `line.strip`, `line.startswith`, `split`, `len`, `float`, `data.append`, `line.replace`

## Tolerance resolution (no hard-coded constants here)

### `_resolve_eps_a`

**Source lines:** `1865-1866`
