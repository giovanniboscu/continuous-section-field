...
This document covers the top-level classes and functions defined in `src/csf/__init__.py`. Imported symbols are not documented as standalone APIs here.

## Module summary

- Source file: `src/csf/__init__.py`
- Output file: `docs/API/__init___api_en.md`
