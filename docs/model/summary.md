...
The change of paradigm is the explicit separation between geometry and sectional participation. Geometry defines where each polygonal region is
...
the application case. The tower is a linearly tapered circular steel tube,
87.6 m tall, with outer diameter tapering from 6.0 m at the base to 3.87 m
at the top and wall thickness from 0.027 m to 0.019 m. Material properties
are uniform: $E = 210$ GPa, $G = 80.8$ GPa, effective density
$\rho = 8500$ kg/m$^3$.
