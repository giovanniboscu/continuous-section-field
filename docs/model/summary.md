...
<p align="center">
  <em> o TABLE 1 - SOLVER INPUT e TABLE 2 - SECTION QUALITY./em>
</p>
...
Quantitatively, the weighted area decreases from $3.65\times10^{15}$ at the end stations to $3.32\times10^{15}$ at mid-span, corresponding to a reduction of about 9.0%. The bending stiffness $I_x$ decreases from $1.29\times10^{20}$ to $9.12\times10^{19}$, a reduction of about 29.2%, whereas $I_y$ changes by less than 0.4%. The polar quantity $I_p$ decreases by about 18.7%. The centroid coordinate $C_y$ shifts from approximately $-190.2$ at the end stations to $-158.6$ at mid-span, reflecting the localized reduction of the lower-web participation.
