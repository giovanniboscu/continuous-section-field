# Version: CSF-CUF scaled Maclaurin tensor ContinuousSectionField-ready v25.1 - 2026-08-30
...
def _reject_options(options):
    if options:
        raise ValueError(
            "scaled_maclaurin_tensor does not accept cuf.basis_options; "
